...
final class MenuViewController: UIViewController {
    ...
    private func setupProfileButton() {
        ...
        profilePortraitView.isUserInteractionEnabled = false
        ...
        profileInitialsLabel.isUserInteractionEnabled = false
        ...
        NSLayoutConstraint.activate([
            profilePortraitView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 16),
